			...
			<div id="translate_post" class="field f_100">
               <div class="option clearfix">
                    ...
                    <?php 
	                    ...
	                    //Deepl
	                    $d_langs = array( "---" ,"Auto-Detect" , "English","German","French","Spanish","Portuguese","Italian","Dutch","Polish","Russian" , "Japanese" , "Chinese" , "Bulgarian","Czech","Danish","Greek","Estonian","Finnish","Hungarian","Lithuanian","Latvian","Romanian","Slovak","Slovenian","Swedish");
	                    $d_langs_c= array('no', 'auto' , "EN","DE","FR","ES","PT","IT","NL","PL","RU" , "JA" , "ZH", "BG","CS","DA","EL","ET","FI","HU","LT","LV","RO","SK","SL","SV" );
